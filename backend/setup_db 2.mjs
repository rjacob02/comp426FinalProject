...
await db.run('CREATE TABLE IF NOT EXISTS entries (id INTEGER PRIMARY KEY AUTOINCREMENT, date TIMESTAMP NOT NULL, title TEXT(100) NOT NULL, body TEXT NOT NULL)');
